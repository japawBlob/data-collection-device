...
#define VECT_TAB_OFFSET  0x00 /*!< Vector Table base offset field. 
...
#if (MII_MODE || RMII_STANDALONE_MODE)
  ...
  /* IMPORTANT NOTE
     ==============
       ...
       must be respected:
         o 25 MHz external crystal connected to OSCIN/OSCOUT pins
         o RCC_PLLCFGR PLL factors configured as follows:
           PLLMx = 4, PLLNx = 64, PLLP = 4.
           This leads to a system clock of 100 MHz.
         o Then set the MCO prescaler to 2 in the RCC_CFGR register to configure
           the system clock to 50 MHz.
     */
#else
#error "RMII or MII ethernet mode must be specified"
#endif /* RMII_MODE */
